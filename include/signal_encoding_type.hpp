...
class PARSER_API SignalEncodingType {
...
public:
	...
	std::vector<std::tuple<std::array<double, 4>, std::string, LinSigEncodingValueType> > getEncodingTypes() const { return encodingTypes; }
	// Setter
